...
import id.co.indocyber.model.WorldModelQuestionGenerator;
...
//        basicWord = "Buaya";
    ...
    private void initComponents() {
        ...
        cmbKategory.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Umum", "Hewan" }));
    ...
    private void btnMulaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMulaiActionPerformed
        if (cmbKategory.getSelectedItem().equals("Umum")) {
            try {
                bankSoal = WorldModelQuestionGenerator.createQuestionFromFile("D://Hewan.txt");
            } catch (IOException ex) {
                Logger.getLogger(GuessingGame.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            try {
                bankSoal = WorldModelQuestionGenerator.createQuestionFromFile("D://File.txt");
            } catch (IOException ex) {
                Logger.getLogger(GuessingGame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
